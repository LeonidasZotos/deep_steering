...
python ./questionnaires_analysis/analyse_political_compass_results.py --scoring_method max_prob # Take most probable answer
python ./questionnaires_analysis/analyse_political_compass_results.py --scoring_method weighted #  Weight answers by their probabilities